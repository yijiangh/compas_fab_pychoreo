...
from pybullet_planning import wait_if_gui, link_from_name, get_link_pose, draw_pose

from compas_fab_pychoreo.pybullet_client import PyBulletClient, get_disabled_collisions
from compas_fab_pychoreo.pybullet_client import pose_from_frame
...
def test_client(fixed_waam_setup, viewer):
    ...
    urdf_filename, robot, tool_frame, tool_mesh, tool = fixed_waam_setup
