...
def compute_movement(process_file, json_out_dir=JSON_OUT_DIR, viewer=False, debug=False, write=False, \
...
def main():
    ...
    parser.add_argument('-p', '--problem', default='rfl_assembly_process.json',
    ...
    compute_movement(args.problem, viewer=args.viewer, debug=args.debug, write=args.write, seq_i=int(args.seq_i), parse_transfer_motion=args.parse_transfer_motion, \
